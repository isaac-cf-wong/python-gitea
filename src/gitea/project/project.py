...
class Project(BaseProject, Resource):
    """Gitea Project resource."""
    ...
    def _delete_project(
        ...
        **kwargs: Any,
        ...
        return self._delete(endpoint=endpoint, params=params, **kwargs)
    ...
    def delete_project_column(
        ...
        **kwargs: Any,
        ...
        """
        response = self._delete_project_column(
            owner=owner,
            repository=repository,
            project_id=project_id,
            column_id=column_id,
    ...
    def _set_default_project_column(
        ...
        **kwargs: Any,
        ...
        return self._post(endpoint=endpoint, params=params, **kwargs)
    ...
    def set_default_project_column(
        ...
        **kwargs: Any,
        ...
        """
        response = self._set_default_project_column(
            owner=owner,
            repository=repository,
            project_id=project_id,
            column_id=column_id,
    ...
    def move_project_columns(
        ...
        **kwargs: Any,
        ...
        """
        response = self._move_project_columns(
            owner=owner,
            repository=repository,
            project_id=project_id,
            column_ids=column_ids,
    ...
    def list_project_column_issues(
        ...
        **kwargs: Any,
        ...
        """
        response = self._list_project_column_issues(
            owner=owner,
            repository=repository,
            project_id=project_id,
            column_id=column_id,
    ...
    def add_issue_to_project_column(
        ...
        **kwargs: Any,
        ...
        """
        response = self._add_issue_to_project_column(
            owner=owner,
            repository=repository,
            project_id=project_id,
            column_id=column_id,
    ...
    def remove_issue_from_project_column(
        ...
        **kwargs: Any,
        ...
        """
        response = self._remove_issue_from_project_column(
            owner=owner,
            repository=repository,
            project_id=project_id,
            column_id=column_id,
    ...
    def move_project_issue(
        ...
        **kwargs: Any,
        ...
        """
        response = self._move_project_issue(
            owner=owner,
            repository=repository,
            project_id=project_id,
            issue_id=issue_id,
