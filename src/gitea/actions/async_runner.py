...
The asynchronous mirror of `gitea.actions.runner`. The endpoints, the arguments
...
class AsyncRunners(BaseActions, AsyncResource):
    """The Actions endpoints over the runners of a scope."""

    async def _list_runners(
        self,
        owner: str | None = None,
    ...
    async def _create_runner_registration_token(
        self,
        owner: str | None = None,
        repository: str | None = None,
        admin: bool = False,
        **kwargs: Any,
        ...
        return await self._post(endpoint=endpoint, **kwargs)
