...
from gitea.utils.response import process_binary_response, process_response


class Artifacts(BaseActions, Resource):
    ...
    def list_artifacts(
        ...
        **kwargs: Any,
        ...
        """
        response = self._list_artifacts(owner=owner, repository=repository, run_id=run_id, name=name, **kwargs)
        data, status_code = process_response(response, default={})
        return cast(dict[str, Any], data), {"status_code": status_code}

    def _get_artifact(self, owner: str, repository: str, artifact_id: int, **kwargs: Any) -> Response:
    ...
    def get_artifact(
        ...
        """
        response = self._get_artifact(owner=owner, repository=repository, artifact_id=artifact_id, **kwargs)
        data, status_code = process_response(response, default={})
        return cast(dict[str, Any], data), {"status_code": status_code}

    def _download_artifact(self, owner: str, repository: str, artifact_id: int, **kwargs: Any) -> Response:
    ...
    def download_artifact(
        ...
        """
        response = self._download_artifact(owner=owner, repository=repository, artifact_id=artifact_id, **kwargs)
        archive, status_code = process_binary_response(response)
        return archive, {"status_code": status_code}

    def _delete_artifact(self, owner: str, repository: str, artifact_id: int, **kwargs: Any) -> Response:
    ...
    def delete_artifact(
        ...
        """
        response = self._delete_artifact(owner=owner, repository=repository, artifact_id=artifact_id, **kwargs)
        data, status_code = process_response(response, default={})
        return cast(dict[str, Any], data), {"status_code": status_code}
