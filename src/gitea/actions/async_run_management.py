...
class AsyncRunManagement(BaseActions, AsyncResource):
    ...
    async def _approve_workflow_run(self, owner: str, repository: str, run_id: int, **kwargs: Any) -> ClientResponse:
    ...
    async def _delete_workflow_run(self, owner: str, repository: str, run_id: int, **kwargs: Any) -> ClientResponse:
