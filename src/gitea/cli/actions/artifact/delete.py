...
The archive is what goes; the run it belongs to stays, and keeps its logs. To
delete a run and everything it produced at once, use
...
COMMAND_NAME = "gitea-cli actions artifact delete"
...
def delete_artifact_command(
    ...
    def api_call() -> tuple[dict[str, Any] | list[dict[str, Any]], dict[str, Any]]:
        ...
        with Gitea(token=token, base_url=base_url) as client:
            return client.actions.delete_artifact(
                owner=owner,
