"""List issue dependencies command."""
...
def list_command(
    ...
    page: Annotated[
        int | None,
        typer.Option("--page", help="Page number for pagination."),
    ] = None,
    limit: Annotated[
        int | None,
        typer.Option("--limit", help="Number of dependencies per page."),
    ] = None,
    ...
    def api_call() -> tuple[dict[str, Any] | list[dict[str, Any]], dict[str, Any]]:
        """List issue dependency information.

        Returns:
            A tuple containing the dependency issues and metadata.

        """
        target_repository = require_repository(repository, command="gitea-cli issue dependency list")
        target_issue = resolve_issue_id(issue_id=issue_id, index=index, command="gitea-cli issue dependency list")

        with Gitea(token=token, base_url=base_url) as client:
            return client.issue.list_issue_dependencies(
                owner=owner,
