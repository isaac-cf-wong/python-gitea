...
def remove_command(
    ...
    def api_call() -> tuple[dict[str, Any] | list[dict[str, Any]], dict[str, Any]]:
        ...
        """
        target_repository = require_repository(repository, command="gitea-cli issue dependency remove")
        target_issue = resolve_issue_id(issue_id=issue_id, index=index, command="gitea-cli issue dependency remove")
        target_dependency_issue = resolve_issue_id(
            issue_id=dependency_issue_id,
            index=dependency_index,
            command="gitea-cli issue dependency remove",
