...
class AsyncNotification(BaseNotification, AsyncResource):
    """Asynchronous Gitea Notification resource."""
    ...
    async def _list_repo_notifications(
        self,
        owner: str,
        repository: str,
        all_notifications: bool | None = None,
    ...
    async def _read_notifications(
        ...
        **kwargs: Any,
        ...
        return await self._put(endpoint=endpoint, params=params, **kwargs)
    ...
    async def _read_repo_notifications(
        self,
        owner: str,
        repository: str,
        last_read_at: datetime | None = None,
    ...
    async def _get_notification_thread(
        self,
        thread_id: int,
        **kwargs: Any,
    ) -> ClientResponse:
    ...
    async def _read_notification_thread(
        self,
        thread_id: int,
        to_status: str | None = None,
        **kwargs: Any,
        ...
        return await self._patch(endpoint=endpoint, params=params, **kwargs)
