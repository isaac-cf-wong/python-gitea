...
We will support the latest stable release of `python-gitea`. Please ensure you
...
If you discover a security vulnerability in `python-gitea`, please report it
...
you for helping make `python-gitea` better and safer!
