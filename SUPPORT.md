...
Thank you for your interest in **python-gitea**!
...
`python-gitea`, please open a
[GitHub Discussion](https://github.com/isaac-cf-wong/python-gitea/discussions)
or [Issue](https://github.com/isaac-cf-wong/python-gitea/issues), depending on
...
[new issue](https://github.com/isaac-cf-wong/python-gitea/issues/new/choose)
with:

- A clear and descriptive title.
- Steps to reproduce the problem.
- Relevant logs or error messages.
- The version of Python and `python-gitea` you're using.
