"""Test importing the python-gitea package and its modules."""
...
def test_import_main_package():
    """Test that the main gitea package can be imported."""
    assert hasattr(gitea, "__version__")
    assert gitea.__version__ is not None


@pytest.mark.parametrize("module_name", get_all_submodules(gitea))
